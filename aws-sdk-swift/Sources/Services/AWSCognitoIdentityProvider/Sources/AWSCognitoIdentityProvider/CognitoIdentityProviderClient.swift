...
extension CognitoIdentityProviderClient {
    ...
    public func getWebAuthnRegistrationOptions(input: GetWebAuthnRegistrationOptionsInput) async throws -> GetWebAuthnRegistrationOptionsOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetWebAuthnRegistrationOptionsInput, GetWebAuthnRegistrationOptionsOutput>(serviceID: serviceName, version: CognitoIdentityProviderClient.version, config: config))
    ...
    public func verifyWebAuthnRegistrationResult(input: VerifyWebAuthnRegistrationResultInput) async throws -> VerifyWebAuthnRegistrationResultOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<VerifyWebAuthnRegistrationResultInput, VerifyWebAuthnRegistrationResultOutput>(serviceID: serviceName, version: CognitoIdentityProviderClient.version, config: config))
