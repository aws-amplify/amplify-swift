...
public class MarketplaceCommerceAnalyticsClientEndpointPlugin: Plugin {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MarketplaceCommerceAnalyticsClient.MarketplaceCommerceAnalyticsClientConfiguration {
            config.authSchemeResolver = DefaultMarketplaceCommerceAnalyticsAuthSchemeResolver()
...
public class MarketplaceCommerceAnalyticsClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemeResolver: MarketplaceCommerceAnalyticsAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
