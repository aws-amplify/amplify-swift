...
public class ElasticLoadBalancingv2ClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ElasticLoadBalancingv2Client.ElasticLoadBalancingv2ClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ElasticLoadBalancingv2Client.ElasticLoadBalancingv2ClientConfiguration {
            config.authSchemeResolver = DefaultElasticLoadBalancingv2AuthSchemeResolver()
...
public class ElasticLoadBalancingv2ClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemeResolver: ElasticLoadBalancingv2AuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
