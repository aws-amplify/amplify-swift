...
All services and features not listed above are supported via the [iOS SDK](https://aws-amplify.github.io/docs/sdk/ios/api) or if supported by a category can be accessed via the Escape Hatch like below:`
