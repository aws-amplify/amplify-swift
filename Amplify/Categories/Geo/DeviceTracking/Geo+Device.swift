...
extension Geo {
    public struct Device {
        ...
        public let tiedToUserId: Bool
        public let tiedToUserAndDevice: Bool
        
        public init(id: String, tiedToUserId: Bool = false, tiedToUserAndDevice: Bool = false) {
            self.id = id
            self.tiedToUserId = tiedToUserId
            self.tiedToUserAndDevice = tiedToUserAndDevice
        }
        ...
        public static func tiedToUser() -> Device {
            return Device(id: "", tiedToUserId: true)
        }
        
        public static func tiedToUserAndDevice() -> Device {
            return Device(id: DeviceIdStore.getDeviceId(), tiedToUserAndDevice: true)
        }
    }
...
//        }
//
////        public static func tiedToUser2() async throws -> Device {
////            let authSession = try await Amplify.Auth.fetchAuthSession()
////            guard let cognitoProvider = authSession as? AuthCognitoIdentityProvider,
////                  let identityId = try? cognitoProvider.getIdentityId().get() else {
////                    return
////            }
////        }
//
