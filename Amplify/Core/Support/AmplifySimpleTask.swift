...
public protocol AmplifySimpleTask {

    associatedtype Success
    associatedtype Request
    associatedtype Failure: AmplifyError

    typealias AmplifySimpleTaskResult = Result<Success, Failure>
    ...
    func dispatch(result: AmplifySimpleTaskResult)

}

public extension AmplifySimpleTask where Self: DefaultLogger {
    var value: Success {
        get async throws {
            do {
