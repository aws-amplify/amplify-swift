...
protocol ModelSyncGraphQLRequestFactory {
    ...
    static func syncQuery(
        ...
        lastSync: Int64?,
        authType: AWSAuthorizationType?
    ) -> GraphQLRequest<SyncQueryResult>
...
extension GraphQLRequest: ModelSyncGraphQLRequestFactory {
    ...
    public static func query(
        ...
        return GraphQLRequest<MutationSyncResult?>(
    ...
    public static func createMutation(
        of model: Model,
        version: Int? = nil,
        authType: AWSAuthorizationType? = nil
    ) -> GraphQLRequest<MutationSyncResult> {
    ...
    public static func updateMutation(
        of model: Model,
    ...
    public static func deleteMutation(
        of model: Model,
        modelSchema: ModelSchema,
        where filter: GraphQLFilter? = nil,
        version: Int? = nil,
        ...
        documentBuilder.add(decorator: ModelIdDecorator(
            model: model,
            schema: modelSchema
        ))
        if let filter {
    ...
    public static func syncQuery(
        ...
        return GraphQLRequest<SyncQueryResult>(
            document: document.stringValue,
            variables: document.variables,
    ...
    private static func createOrUpdateMutation(
        of model: Model,
        modelSchema: ModelSchema,
        where filter: GraphQLFilter? = nil,
