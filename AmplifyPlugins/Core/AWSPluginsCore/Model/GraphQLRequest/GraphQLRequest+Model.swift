...
extension GraphQLRequest: ModelGraphQLRequestFactory {
    private static func modelSchema(for model: some Model) -> ModelSchema {
    ...
    public static func mutation<M: Model>(
        of model: M,
        where predicate: QueryPredicate? = nil,
        includes: IncludedAssociations<M> = { _ in [] },
        type: GraphQLMutationType,
    ...
    public static func get<M: Model>(
        _ modelType: M.Type,
        byId id: String,
        includes: IncludedAssociations<M> = { _ in [] },
        authMode: AWSAuthorizationType? = nil
    ...
    public static func subscription<M: Model>(
        of modelType: M.Type,
        type: GraphQLSubscriptionType,
        includes: IncludedAssociations<M> = { _ in [] },
        authMode: AWSAuthorizationType? = nil
