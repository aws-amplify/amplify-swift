...
class QueryPredicateEvaluateGeneratedIntBetweenTests: XCTestCase {
    ...
    func testbetweenInt1betweenInt1with1() throws {
       let predicate = QPredGen.keys.myInt.between(start: 1, end: 1)
       var instance = QPredGen(name: "test")
       instance.myInt = 1
    ...
    func testbetweenInt1betweenInt1with2() throws {
       let predicate = QPredGen.keys.myInt.between(start: 1, end: 1)
       var instance = QPredGen(name: "test")
       instance.myInt = 2
    ...
    func testbetweenInt1betweenInt1with3() throws {
       let predicate = QPredGen.keys.myInt.between(start: 1, end: 1)
       var instance = QPredGen(name: "test")
       instance.myInt = 3
    ...
    func testbetweenInt1betweenInt2with1() throws {
       let predicate = QPredGen.keys.myInt.between(start: 1, end: 2)
       var instance = QPredGen(name: "test")
       instance.myInt = 1
    ...
    func testbetweenInt1betweenInt2with2() throws {
       let predicate = QPredGen.keys.myInt.between(start: 1, end: 2)
       var instance = QPredGen(name: "test")
       instance.myInt = 2
    ...
    func testbetweenInt1betweenInt2with3() throws {
       let predicate = QPredGen.keys.myInt.between(start: 1, end: 2)
       var instance = QPredGen(name: "test")
       instance.myInt = 3
    ...
    func testbetweenInt2betweenInt2with1() throws {
       let predicate = QPredGen.keys.myInt.between(start: 2, end: 2)
       var instance = QPredGen(name: "test")
       instance.myInt = 1
    ...
    func testbetweenInt2betweenInt2with2() throws {
       let predicate = QPredGen.keys.myInt.between(start: 2, end: 2)
       var instance = QPredGen(name: "test")
       instance.myInt = 2
    ...
    func testbetweenInt2betweenInt2with3() throws {
       let predicate = QPredGen.keys.myInt.between(start: 2, end: 2)
       var instance = QPredGen(name: "test")
       instance.myInt = 3
    ...
    func testbetweenInt2betweenInt3with1() throws {
       let predicate = QPredGen.keys.myInt.between(start: 2, end: 3)
       var instance = QPredGen(name: "test")
       instance.myInt = 1
    ...
    func testbetweenInt2betweenInt3with2() throws {
       let predicate = QPredGen.keys.myInt.between(start: 2, end: 3)
       var instance = QPredGen(name: "test")
       instance.myInt = 2
    ...
    func testbetweenInt2betweenInt3with3() throws {
       let predicate = QPredGen.keys.myInt.between(start: 2, end: 3)
       var instance = QPredGen(name: "test")
       instance.myInt = 3
    ...
    func testbetweenInt3betweenInt3with1() throws {
       let predicate = QPredGen.keys.myInt.between(start: 3, end: 3)
       var instance = QPredGen(name: "test")
       instance.myInt = 1
    ...
    func testbetweenInt3betweenInt3with2() throws {
       let predicate = QPredGen.keys.myInt.between(start: 3, end: 3)
       var instance = QPredGen(name: "test")
       instance.myInt = 2
    ...
    func testbetweenInt3betweenInt3with3() throws {
       let predicate = QPredGen.keys.myInt.between(start: 3, end: 3)
       var instance = QPredGen(name: "test")
       instance.myInt = 3
