...
class GraphQLRequestJSONNonModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let colorName =  ModelField(
            name: "name",
            type: .string,
            isRequired: true
        )
        let colorR =  ModelField(
            name: "red",
            type: .int,
            isRequired: true
        )
        let colorG =  ModelField(
            name: "green",
            type: .int,
            isRequired: true
        )
        let colorB =  ModelField(
            name: "blue",
            type: .int,
            isRequired: true
        )
        ...
        let todoName = ModelField(
            name: "name",
            type: .string,
            isRequired: true
        )
        let todoDescription = ModelField(
            name: "description",
            type: .string
        )
