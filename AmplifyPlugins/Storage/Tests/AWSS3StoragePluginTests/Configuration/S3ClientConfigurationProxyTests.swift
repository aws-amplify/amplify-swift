...
//    private func configuration(accelerate: Bool) async throws -> S3ClientConfiguration {
//        S3ClientConfiguration(
//            region: "us-east-1",
//            credentialsProvider: MockCredentialsProvider {
//                .init(accessKey: "", secret: "", expirationTimeout: nil, sessionToken: nil)
//            },
...
struct MockCredentialsProvider: CredentialsProvider {
    let _fetchCredentials: () async throws -> Credentials

    func fetchCredentials() async throws -> Credentials {
        try await _fetchCredentials()
    }
}
