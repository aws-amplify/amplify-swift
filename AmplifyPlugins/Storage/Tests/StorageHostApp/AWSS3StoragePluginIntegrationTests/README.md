...
> Email based user registration/forgot password: 
    1Enabled (Requires per-user email entry at registration)`
...
```sh
cp amplifyconfiguration.json \
    ~/.aws-amplify/amplify-ios/testconfiguration/AWSS3StoragePluginTests-amplifyconfiguration.json
```
