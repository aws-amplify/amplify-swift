...
extension String {
    func urlPercentEncoding() -> String {
        self
    }
}
...
//            "If-Unmodified-Since": ifUnmodifiedSince,
    ...
    var queryItems: [URLQueryItem] {
        [
            ...
            .init(name: "versionId".urlPercentEncoding(), value: versionId?.urlPercentEncoding()),
            .init(name: "response-content-disposition".urlPercentEncoding(), value: responseContentDisposition?.urlPercentEncoding()),
            .init(name: "partNumber".urlPercentEncoding(), value: partNumber.map(String.init)?.urlPercentEncoding()),
            .init(name: "response-content-type".urlPercentEncoding(), value: responseContentType?.urlPercentEncoding()),
            //            .init(name: "response-expires".urlPercentEncoding(), value: responseExpires.urlPercentEncoding())
            .init(name: "response-content-encoding".urlPercentEncoding(), value: responseContentEncoding?.urlPercentEncoding()),
            .init(name: "response-cache-control".urlPercentEncoding(), value: responseCacheControl?.urlPercentEncoding()),
            .init(name: "response-content-language".urlPercentEncoding(), value: responseContentLanguage?.urlPercentEncoding()),
        ]
    }
