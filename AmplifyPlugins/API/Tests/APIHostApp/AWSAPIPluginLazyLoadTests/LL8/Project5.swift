...
public struct Project5: Model {
  ...
  public mutating func setTeam(_ team: Team5? = nil) {
  ...
  public init(from decoder: Decoder) throws {
      ...
      self._team = try values.decodeIfPresent(LazyReference<Team5>.self, forKey: .team) ?? LazyReference(identifiers: nil)
