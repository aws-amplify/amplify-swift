...
final class GraphQLTodo17Tests: AWSAPIPluginGen2GraphQLBaseTest {
    ...
    func testCodeSnippet() async throws {
        await setup(withModels: Todo17Models(), withAuthPlugin: true)
...
extension GraphQLTodo17Tests: DefaultLogger { }

extension GraphQLTodo17Tests {
    typealias Todo = Todo17

    struct Todo17Models: AmplifyModelRegistration {
        public let version: String = "version"
        func registerModels(registry: ModelRegistry.Type) {
            ModelRegistry.register(modelType: Todo17.self)
        }
    }
}
