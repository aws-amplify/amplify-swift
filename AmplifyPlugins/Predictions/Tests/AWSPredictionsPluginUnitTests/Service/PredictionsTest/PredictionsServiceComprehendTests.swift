...
//        let english = ComprehendClientTypes.DominantLanguage(languageCode: "en", score: 0.5)
...
//    // MARK: - Helper methods
//
//    private func mockDominantLanguageResult(_ languages: [ComprehendClientTypes.DominantLanguage]? = nil)
//    -> ComprehendClientTypes.BatchDetectDominantLanguageItemResult //  AWSComprehendDetectDominantLanguageResponse {
//            let mockResponse = ComprehendClientTypes.BatchDetectDominantLanguageItemResult()
