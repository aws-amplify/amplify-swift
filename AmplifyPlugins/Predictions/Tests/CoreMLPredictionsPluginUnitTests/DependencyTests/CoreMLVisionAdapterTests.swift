...
class CoreMLVisionAdapterTests: XCTestCase {
    ...
    func testDetectLabels() throws {
        let url = try XCTUnwrap(Bundle.module.url(forResource: "people", withExtension: "jpg", subdirectory: "TestImages"))
    ...
    func testDetectText() throws {
        ...
        let url = try XCTUnwrap(Bundle.module.url(forResource: "screenshotWithText", withExtension: "png", subdirectory: "TestImages"))
