...
public class CloudWatchClient {
    ...
    func describeLogStreams(input: DescribeLogStreamsInput) async throws -> DescribeLogStreamsOutputResponse {
        ...
        let action = Action.describeLogStreams(input: input)
    ...
    func createLogStream(input: CreateLogStreamInput) async throws -> CreateLogStreamOutputResponse {
        ...
        let action = Action.createLogStream(input: input)
        return try await request(action: action, input: input)
    }
    ...
    func putLogEvents(input: PutLogEventsInput) async throws -> PutLogEventsOutputResponse {
        ...
        let action = Action.putLogEvents(input: input)
        return try await request(action: action, input: input)
    }
    ...
    func filterLogEvents(input: FilterLogEventsInput) async throws -> FilterLogEventsOutputResponse {
        ...
        let action = Action.filterLogEvents(input: input)
        return try await request(action: action, input: input)
    }
}

extension CloudWatchClient: DefaultLogger { 
    public static let log: Logger = {
        Amplify.Logging.logger(
            forCategory: "CloudWatchClient",
            forNamespace: "CloudWatchClient"
        )
    }()
