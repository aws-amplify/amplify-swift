...
final class LogRotationTests: XCTestCase {
    ...
    func testLogRotationDefaultState() throws {
        ...
        XCTAssertEqual(contents.map(\.lastPathComponent), [
            "amplify.0.log"
        ])
    }
    ...
    func testLogRotationCreatesNewFiles() throws {
        ...
        XCTAssertEqual(rotatedContents.map(\.lastPathComponent), [
            "amplify.2.log",
            "amplify.1.log",
            "amplify.0.log",
        ])
    ...
    func testLogRotationToMaxLimit() async throws {
        ...
        XCTAssertEqual(Set(allFiles.map(\.lastPathComponent)), Set([
            "amplify.0.log",
            "amplify.1.log",
            "amplify.2.log",
            "amplify.3.log",
