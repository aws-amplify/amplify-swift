...
class OutgoingMutationQueueNetworkTests: SyncEngineTestBase {
    ...
    func testLastMutationSentWhenNoNetwork() async throws {
        ...
        await fulfillment(of: [createdNewItem, apiRespondedWithSuccess], timeout: 1)
        ...
        await fulfillment(of: [savedUpdate1], timeout: 1)
        ...
        await fulfillment(of: [savedUpdate2], timeout: 1)
        ...
        await fulfillment(of: [savedFinalUpdate], timeout: 1)
    ...
    private func setUpSubsequentMutationRequestResponder(
        ...
        return { request, eventListener in
