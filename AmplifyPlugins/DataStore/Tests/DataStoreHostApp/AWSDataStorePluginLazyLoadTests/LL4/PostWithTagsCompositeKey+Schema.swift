...
public extension PostWithTagsCompositeKey {
  ...
  static let schema = defineSchema { model in
    ...
    class Path: ModelPath<PostWithTagsCompositeKey> { }
...
public extension ModelPath where ModelType == PostWithTagsCompositeKey {
  ...
  var tags: ModelPath<PostTagsWithCompositeKey>   {
