...
public struct PostTagsWithCompositeKey: Model {
    ...
    var _postWithTagsCompositeKey: LazyReference<PostWithTagsCompositeKey>
    public var postWithTagsCompositeKey: PostWithTagsCompositeKey   {
        get async throws {
            try await _postWithTagsCompositeKey.require()
        }
    }
    var _tagWithCompositeKey: LazyReference<TagWithCompositeKey>
    ...
    public mutating func setPostWithTagsCompositeKey(_ postWithTagsCompositeKey: PostWithTagsCompositeKey) {
        _postWithTagsCompositeKey = LazyReference(postWithTagsCompositeKey)
    }
    public mutating func setTagWithCompositeKey(_ tagWithCompositeKey: TagWithCompositeKey) {
        _tagWithCompositeKey = LazyReference(tagWithCompositeKey)
    }
    public init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        self.id = try values.decode(String.self, forKey: .id)
        self._postWithTagsCompositeKey = try values.decodeIfPresent(LazyReference<PostWithTagsCompositeKey>.self, forKey: .postWithTagsCompositeKey) ?? LazyReference(identifiers: nil)
        self._tagWithCompositeKey = try values.decodeIfPresent(LazyReference<TagWithCompositeKey>.self, forKey: .tagWithCompositeKey) ?? LazyReference(identifiers: nil)
