...
5. Copy `amplifyconfiguration.json` to a new file named `AWSDataStoreStressTests-amplifyconfiguration.json` inside `~/.aws-amplify/amplify-ios/testconfiguration/`
