...
final class IncomingSubscriptionListener {
    ...
    init(modelType: Model.Type, api: APICategoryGraphQLBehavior) {
        let log = Amplify.Logging.logger(forCategory: "IncomingSubscriptionListener")
...
extension IncomingSubscriptionListener: DefaultLogger { }
