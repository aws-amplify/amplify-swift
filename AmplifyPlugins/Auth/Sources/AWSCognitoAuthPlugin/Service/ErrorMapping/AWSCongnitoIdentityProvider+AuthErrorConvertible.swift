...
extension InternalErrorException: AuthErrorConvertible {
    ...
    var authError: AuthError {
        .unknown(message ?? fallbackDescription)
    }
}
...
extension ConcurrentModificationException: AuthErrorConvertible {
...
extension EnableSoftwareTokenMFAException: AuthErrorConvertible {
