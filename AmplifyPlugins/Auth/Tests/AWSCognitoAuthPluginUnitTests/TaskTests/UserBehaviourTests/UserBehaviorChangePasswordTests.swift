...
class UserBehaviorChangePasswordTests: BasePluginTest {
    ...
    func testChangePasswordWithInternalErrorException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.InternalErrorException(message: "internal error exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
    ...
    func testChangePasswordWithInvalidParameterException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.InvalidParameterException(message: "invalid parameter exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithInvalidPasswordException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.InvalidPasswordException(message: "invalid password exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithNotAuthorizedException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.NotAuthorizedException(message: "not authorized exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithPasswordResetRequiredException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.PasswordResetRequiredException(message: "password reset required exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithResourceNotFoundException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.ResourceNotFoundException(message: "resource not found exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithTooManyRequestsException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.TooManyRequestsException(message: "too many requests exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithUserNotConfirmedException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.UserNotConfirmedException(message: "user not confirmed exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
    ...
    func testChangePasswordWithUserNotFoundException() async throws {
        ...
        self.mockIdentityProvider = MockIdentityProvider(mockChangePasswordOutputResponse: { _ in
            throw AWSCognitoIdentityProvider.UserNotFoundException(message: "user not found exception")
        })
        do {
            try await plugin.update(oldPassword: "old password", to: "new password")
            XCTFail("Should return an error if the result from service is invalid")
