...
class AWSAuthBaseTest: XCTestCase {
    ...
    let amplifyConfigurationFile = "testconfiguration/AWSAuthStressTests-amplifyconfiguration"
    let credentialsFile = "testconfiguration/AWSAuthStressTests-credentials"
