...
class AWSPinpointAnalyticsPluginConfigurationTests: XCTestCase {
    ...
    func testConfigureSuccess_withTargetingConfiguration() throws {
        ...
        do {
            ...
            XCTAssertEqual(config.autoFlushEventsInterval,
                           AWSPinpointAnalyticsPluginOptions.defaultAutoFlushEventsInterval)
            XCTAssertEqual(config.trackAppSessions,
                           AWSPinpointAnalyticsPluginOptions.defaultTrackAppSession)
            XCTAssertEqual(config.autoSessionTrackingInterval,
                           AWSPinpointAnalyticsPluginOptions.defaultAutoSessionTrackingInterval)
        } catch {
    ...
    func testConfigureWithAutoSessionTrackingIntervalSuccess() {
        ...
        do {
            ...
            XCTAssertEqual(config.autoFlushEventsInterval,
                           AWSPinpointAnalyticsPluginOptions.defaultAutoFlushEventsInterval)
            XCTAssertEqual(config.trackAppSessions, AWSPinpointAnalyticsPluginOptions.defaultTrackAppSession)
    ...
    func testConfigureThrowsErrorForMissingPinpointAnalyticsAppId() {
        ...
        XCTAssertThrowsError(try AWSPinpointAnalyticsPluginConfiguration(analyticsPluginConfig)) { error in
            ...
            XCTAssertEqual(errorDescription, AWSPinpointErrorConstants.missingAppId.errorDescription)
        }
    }
    ...
    func testConfigureThrowsErrorForEmptyPinpointAnalyticsAppIdValue() {
        ...
        XCTAssertThrowsError(try AWSPinpointAnalyticsPluginConfiguration(analyticsPluginConfig)) { error in
            ...
            XCTAssertEqual(errorDescription, AWSPinpointErrorConstants.emptyAppId.errorDescription)
        }
    }
    ...
    func testConfigureThrowsErrorForInvalidPinpointAnalyticsAppIdValue() {
        ...
        XCTAssertThrowsError(try AWSPinpointAnalyticsPluginConfiguration(analyticsPluginConfig)) { error in
            ...
            XCTAssertEqual(errorDescription, AWSPinpointErrorConstants.invalidAppId.errorDescription)
        }
    }
    ...
    func testConfigureThrowsErrorForMissingPinpointAnalyticsRegion() {
        ...
        XCTAssertThrowsError(try AWSPinpointAnalyticsPluginConfiguration(analyticsPluginConfig)) { error in
            ...
            XCTAssertEqual(errorDescription, AWSPinpointErrorConstants.missingRegion.errorDescription)
        }
    }
    ...
    func testConfigureThrowsErrorForEmptyPinpointAnalyticsRegionValue() {
        ...
        XCTAssertThrowsError(try AWSPinpointAnalyticsPluginConfiguration(analyticsPluginConfig)) { error in
            ...
            XCTAssertEqual(errorDescription, AWSPinpointErrorConstants.emptyRegion.errorDescription)
        }
    }
