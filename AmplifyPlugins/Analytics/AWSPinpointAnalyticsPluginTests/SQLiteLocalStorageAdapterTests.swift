  ...
  func testLocalStorageInsert() {
    do {
      ...
      let insertStatement = """
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """
      let bindings: [Binding] = [1, "", "", "", 100000, 2, 1_000_000, 1_000_000, 100000, 1, 0]
  ...
  func testLocalStorageUpdate() {
    do {
      let insertStatement = """
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """
      let bindings: [Binding] = [123, "", "", "", 100000, 2, 1_000_000, 1_000_000, 100000, 0, 0]
      _ = try adapter.executeQuery(insertStatement, bindings)
    ...
    do {
      ...
      for _ in 0...100 {
        let bindings: [Binding] = [
          Int.random(in: 1...1000), "attributes", "eventType", "metrics", 1_654_796_845, 1,
          1_654_796_847, 1_654_796_848, 1_654_796_845, 0, 0
        ]
        _ = try adapter.executeQuery(insertStatement, bindings)
      }
