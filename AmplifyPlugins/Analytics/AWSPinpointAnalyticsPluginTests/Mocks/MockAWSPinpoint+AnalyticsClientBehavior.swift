...
extension MockAWSPinpoint: AWSPinpointAnalyticsClientBehavior {
  ...
  public func addGlobalAttribute(
  ...
  public func addGlobalMetric(
    _ theValue: Double, forKey theKey: String, forEventType theEventType: String
  ) {
    addGlobalMetricCalled += 1
  ...
  public func createAppleMonetizationEvent(
  ...
  public func createVirtualMonetizationEvent(
