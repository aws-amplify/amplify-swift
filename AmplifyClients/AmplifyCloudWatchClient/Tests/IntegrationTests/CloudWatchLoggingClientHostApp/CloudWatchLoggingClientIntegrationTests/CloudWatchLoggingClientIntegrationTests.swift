...
class CloudWatchLoggingClientIntegrationTests: XCTestCase {
    ...
    var loggingClient: AmplifyCloudWatchClient!
    ...
    override func setUp() async throws {
        ...
        loggingClient = try AmplifyCloudWatchClient(
    ...
    /// - Given: an AmplifyCloudWatchClient
    ...
    /// - Given: an AmplifyCloudWatchClient with logging enabled
    ...
    /// - Given: an AmplifyCloudWatchClient with logging disabled
    /// - When: a verbose log message is emitted and flushed
