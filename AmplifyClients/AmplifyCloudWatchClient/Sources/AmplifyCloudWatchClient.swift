...
public typealias AmplifyCloudWatchClientConfigurationProvider = (
...
/// Example usage:
/// ```swift
/// let loggingClient = AmplifyCloudWatchClient(
///     region: "us-east-1",
...
@_spi(AmplifyExperimental)
public final class AmplifyCloudWatchClient: AmplifyFoundation.LogSinkBehavior, @unchecked Sendable {
    ...
    private let logger = AmplifyFoundation.AmplifyLogging.logger(for: AmplifyCloudWatchClient.self)
    ...
    public struct Options {
        ...
        public let configureClient: AmplifyCloudWatchClientConfigurationProvider?
        ...
        public init(
            ...
            configureClient: AmplifyCloudWatchClientConfigurationProvider? = nil
        ) {
    ...
    /// Initializes a new AmplifyCloudWatchClient instance.
    public init(
        region: String,
...
@available(iOS 13.0, macOS 12.0, tvOS 13.0, watchOS 9.0, *)
extension AmplifyCloudWatchClient: CloudWatchLoggingMonitorDelegate {
