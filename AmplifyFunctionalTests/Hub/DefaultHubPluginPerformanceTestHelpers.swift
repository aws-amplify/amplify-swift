...
enum DefaultHubPluginPerformanceTestHelpers {
    ...
    static func makeTestObjectsForSingleChannel(
        listenerCount: Int,
        dispatcherType: (some Dispatcher).Type,
        testCase: XCTestCase
    ) -> PerformanceTestObjects {
        ...
        return makeTestObjectsForDispatcherTypes(
    ...
    static func makeTestObjectsForSingleDispatcher(
        listenerCount: Int,
        dispatcherType: (some Dispatcher).Type,
        testCase: XCTestCase
    ) -> PerformanceTestObjects {
    ...
    static func makeTestObjectsForMultipleDispatchers(
        listenerCount: Int,
        dispatcherType: (some Dispatcher).Type,
        testCase: XCTestCase
    ) -> PerformanceTestObjects {
    ...
    static func makeTestObjectsForDispatcherTypes(
        listenerCount: Int,
        ...
        let (listeners, expectations) = makeListeners(
            count: listenerCount,
        ...
        let objects = PerformanceTestObjects(
    ...
    static func makeListeners(
        ...
        expectedChannels: [HubChannel],
        testCase: XCTestCase
    ) -> ([FilteredListener], [XCTestExpectation]) {
